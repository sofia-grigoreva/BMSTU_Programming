...
public class EqMealy {
    ...
    List<List<String>> v;
    List<Integer> Q2;
    public EqMealy(int n, int m, int q0, List<List<Integer>> p, List<List<String>> v) {
        this.n = n;
        this.m = m;
        this.p = p;
        this.v = v;
    ...
    List<List<Integer>>  Canon_p (){
        ...
        if (Q2.indexOf(q0) == -1){
         ...
         for (int i = 0; i < n; i++) {
             for (j = 0; j < m; j++){
                 p3.get(i).set(j, mark[p3.get(i).get(j)]);
             }
         }
    ...
    public static void main(String[] args) {
        ...
        EqMealy mealy = new EqMealy(n, m, q0,  p, v);
        EqMealy mealy2 = new EqMealy(n2, m2, q02, p2, v2);

        p = mealy.Canon_p();
        v = mealy.Canon_v();
        p2 = mealy2.Canon_p();
        v2 = mealy2.Canon_v();
        if (Objects.equals(p, p2) && Objects.equals(v, v2)){
